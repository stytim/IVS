...
{
    public static IEnumerator LoadAnchor(GameObject go, string fileName)
    {
        var guidStr = ReadGuid(fileName);
    ...
    public static IEnumerator CreateAndSaveAnchor(GameObject go, string fileName)
    {
        ...
        if (newAnchor && newAnchor.Created)
        {
            ...
            if (saveResult.Success)
                WriteGuid(newAnchor.Uuid.ToString(), fileName);
        }
        else
        {
    ...
    public static void DeleteAnchorFile(string fileName)
    {
        var filePath = Application.persistentDataPath + fileName;
        File.Delete(filePath);
    }

    private static string ReadGuid(string fileName)
    {
        var filePath = Application.persistentDataPath + fileName;
    ...
    private static void WriteGuid(string guidStr, string filename)
    {
